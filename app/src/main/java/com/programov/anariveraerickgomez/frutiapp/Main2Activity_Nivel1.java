...
public class Main2Activity_Nivel1 extends AppCompatActivity {
    ...
    public void BaseDeDatos(){
        ...
        AdminSQLiteOpenHelper admin2 = new AdminSQLiteOpenHelper(this, "PUNTAJES", null, 1);
        SQLiteDatabase hpuntaje = admin2.getWritableDatabase();


        Cursor consulta = BD.rawQuery("select * from puntaje where score = (select max(score) from puntaje)", null);
        Cursor consulta2 = hpuntaje.rawQuery("select * from hpuntaje", null);

        ContentValues insertar2 = new ContentValues();

        insertar2.put("nombre", nombre_jugador);
        insertar2.put("score", score);
        hpuntaje.insert("puntaje", null, insertar2);
